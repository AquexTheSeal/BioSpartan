...
public class BSStandardWeapons {
    public SwordBaseItem fleignarite;
    public SwordBaseItem reinforcedFleignarite;

    public BSStandardWeapons(WeaponFactory.WeaponFunction<SwordBaseItem> factory) {
