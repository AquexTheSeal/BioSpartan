...
public class ReinforcedFleignariteRangedProperty extends RangedCallbackWeaponTrait {

    public ReinforcedFleignariteRangedProperty(String propType, String propModId) {
    ...
    public void onProjectileSpawn(WeaponMaterial material, AbstractArrowEntity projectile) {
        ...
        ((IAbstractArrowMixin) projectile).setWeaponType(WeaponMaterialTypes.REINFORCED_FLEIGNARITE);
    }
